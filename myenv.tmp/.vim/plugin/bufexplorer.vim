...
"               Permissio[1],n[2]n is hereby granted to use and distribute this code,
...
" Public Interface {{{1
if maparg("<Leader>bb") =~ 'BufExplorer'
  nunmap <Leader>bb
endif
...
function! s:BERemoveBuffer(type, mode) range
    ...
    for lineNum in range(a:firstline, a:lastline)
        ...
        if line =~ '^\s*\(\d\+\)'
            ...
            " Add 0 to bufNbr to ensure[3] Vim treats it as a Number
